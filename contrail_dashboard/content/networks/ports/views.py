...
from contrail_dashboard.content.networks.ports import forms as project_forms
from contrail_dashboard.content.networks.ports import tabs as project_tabs
