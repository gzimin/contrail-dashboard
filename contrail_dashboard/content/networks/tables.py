...
class ModifyAttachedPolicies(policy.PolicyTargetMixin, tables.LinkAction):
    name = "modify_attached_policies"
    verbose_name = _("Modify Associated Policies")
    url = "horizon:project:networks:modify_attached_policies"
...
def get_policies(network):
    if hasattr(network, 'policys'):
        template_name = 'project/networks/_network_policies.html'
...
class NetworksTable(tables.DataTable):
    ...
    class Meta(object):
        ...
        row_actions = (EditNetwork, CreateSubnet,
                       ModifyAttachedPolicies, DeleteNetwork)
